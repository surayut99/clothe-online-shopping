...
@section('content')
<div class="container">
    <h1 class="pt-3">แสดงรายการสินค้า @if(Session::has('keyword'))"{{$keyword}}"@endif</h1>
    @if(count($products) > 0)
    <div id="between-content" class="d-flex p-1 bd-highlight sp-flex space-bottom">

        @foreach($products as $product)
        <div style="background-color: whitesmoke; border-radius:10px; width:20vw; height: 52vh" class="p-3">
            ...
            <div class="mt-3" style="color:black">
                <h4 class="shrink-text" style="color:black; height:35px">{{$product->product_name}}</h4>
